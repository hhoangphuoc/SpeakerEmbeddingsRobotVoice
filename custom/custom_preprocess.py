'''
Copied from original TRIAAN-VC repository: https://github.com/winddori2002/TriAAN-VC/preprocess.py

Modified with different import modules from custom model
'''
...
from processing.modified_audio_process import *

## TODO: MODIFIED TO ALIGN WITH CUSTOM MODEL
def main(cfg):
