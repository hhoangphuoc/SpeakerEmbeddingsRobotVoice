...
from models.triaanvc.src.vocoder import decode
from models.triaanvc.src.cpc import *


# from models.triaanvc.config import * # FIXME: Replace by custom config folder with different yaml files
